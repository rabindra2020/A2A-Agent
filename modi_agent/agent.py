...
class ModiAgent():
    ...
    def __init__(self):
        ...
        self.agent = Agent(
                    ...
                    goal="Answer questions about Modi's availability.",
                    backstory="You are a helpful scheduling assistant who checks Modi's calendar.",
    ...
    async def invoke(self, user_question):
        try:
            task = Task(
                ...
                expected_output="A clear answer about Modi's availability.",
                agent=self.agent
            )
            ...
            print(f"[ERROR] Modi_agent.invoke: {e}")
