...
from agent_executor import ModiAgentExecutor
...
def main(host = "localhost", port = 10004):
    ...
    skill = AgentSkill(
        ...
        description="Helps with finding Narendra Modi's availability for Badminton",
    ...
    agent_card = AgentCard(
        ...
        version="1.0.0",
        defaultInputModes=ModiAgent.SUPPORTED_CONTENT_TYPES,
        defaultOutputModes=ModiAgent.SUPPORTED_CONTENT_TYPES,
    ...
    request_handler = DefaultRequestHandler(
        agent_executor=ModiAgentExecutor(),
